...
namespace RTSim {
    ...
    */
    ...
    protected:
        ...
        /// the MissCount instance for this task instance
        MissCount* _missCounter;

	/// task index, which you can set manually
	...
	inline unsigned int getIndex() const { return _index; }
        ...
        */
        ...
        void setMissCount(MissCount* mc) { _missCounter = mc; }
	...
	virtual void setLastSched(Tick ls) {_lastSched = ls;}
        ...
        */
        ...
        /// Returns the remaining part of WCET, in cycles (frequency independent)
        /// Requires the queues instance (todo model it as singleton)
        //virtual Tick getRemainingWCETCycles(MultiCoresScheds* queues) const;
